 ...
 *
 * 二、Map结构的理解
 *      Map中的key：无序的、不可重复的，使用Set存储的所有的key    ----》 key所在的类要重写equals() 和 hashCode() (以HashMap为例)
...
//        map = new Hashtable();
    ...
    public void test3(){
        ...
        ///是否包含指定的key
       boolean isHave =  map.containsKey(12);
